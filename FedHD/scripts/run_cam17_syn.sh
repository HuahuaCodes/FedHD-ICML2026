...
#PBS -l jobfs=20GB
#PBS -N fedhd_cam17_syn

CODE_ROOT=/scratch/iq24/cc0395/FedHD
cd $CODE_ROOT
source /g/data/iq24/mmcv_env/bin/activate

# NOTE: UNI_features for CAMELYON17 must be pre-extracted before running.
# PAPER_CONFIGS C1 uses UNI_features. Run feature extraction if not done.
